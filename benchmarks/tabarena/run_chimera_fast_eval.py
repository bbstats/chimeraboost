"""Evaluate ChimeraBoost_fast (quality=1) -> Elo.

Mirrors run_chimera_eval.py but for the fast-rung method/output dir. The
baseline pool is already cached from the default eval, so this is fast.
"""
...
PATH_RAW = r"A:\code\tabarena_out\chimera_fast"
FIG_OUTPUT_DIR = r"A:\code\tabarena_out\evals\chimera_fast"
METHOD = "ChimeraBoost_fast"  # == ChimeraBoostFastModel.ag_name
...
if __name__ == "__main__":
    ...
    out_md = r"A:\code\tabarena_out\evals\chimera_fast_leaderboard.md"
    with open(out_md, "w", encoding="utf-8") as fh:
        fh.write(md)
    leaderboard_website.to_csv(r"A:\code\tabarena_out\evals\chimera_fast_leaderboard.csv", index=False)
