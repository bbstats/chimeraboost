...
| Runs of record | `suite="tabarena-2026-06-30"` (superseded — its fit times include our numba JIT) and `suite="tabarena-2026-07-13"` (the warm-started rerun). Both are default-config; **there is still no tuned row.** |
