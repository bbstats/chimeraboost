...
15/15 fits each, exactly. Lead = RoNGBa's CRPS below ours as % of ours
...
|---|---|---|---|---|---|---|
| visualizing_soil | S S S | +25.5% | +68.5% | closes 160% | -33% | 1999, 2000, 2000 |
| SGEMM | B B B | +7.6% | +17.4% | closes 117% | -151% | 427, 411, 478 |
| pol | S S S | +1.4% | +3.0% | -1% | +6% | 803, 1335, 1564 |
| cpu_act (control) | S S S | -6.3% | -4.0% | CRPS +2.9% worse | | 255-364 |
| houses (control) | S S S | -11.0% | -13.4% | CRPS +13% worse | | 594-692 |
...
37% narrower at equal coverage (7.2 vs 11.4; 89.4% vs 89.6%), where our
fixed width (S) wins the audition. (4) The S/N centre is the point
