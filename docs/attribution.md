...
| The quantile head's "fixed" and "scaled" candidates: a point model plus the quantiles of its held-out errors, and the same errors measured in units of a second model's predicted spread | Split conformal prediction, Papadopoulos et al., ECML 2002, and Lei et al., JASA 2018; normalized nonconformity scores, Papadopoulos, Gammerman & Vovk 2008, the locally weighted form in Lei et al. 2018 |
